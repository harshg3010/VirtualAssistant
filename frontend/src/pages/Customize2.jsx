...
const Customize2 = () => {
  ...
  return (
    <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#03034ddc] flex justify-center items-center flex-col p-[20px] relative">
      <MdArrowBack
      ...
      {assistantName && (
        <button
          className="min-w-[300px] h-[60px] mt-[30px] cursor-pointer bg-white rounded-full text-black text-[19px] font-semibold "
          disabled={loading}
          onClick={() => {
